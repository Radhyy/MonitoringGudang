    ...
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center gap-4">
        ...
        <PageHeader 
          ...
          description="Buat akun baru untuk staf gudang atau tim packing." 
        />
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-700">Role / Hak Akses</label>
              <select 
                name="role"
                value={formData.role}
                onChange={handleChange}
            ...
            <div className="space-y-2">
              ...
              <input 
                ...
                onChange={handleChange}
                placeholder="Misal: budi@gudang.com"
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors"
              />
            </div>
          ...
          <div className="pt-6 border-t border-slate-100 flex justify-end gap-3">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-xl transition-colors shadow-sm shadow-blue-200 flex items-center justify-center min-w-[120px] disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {loading ? (
